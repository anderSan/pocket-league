package info.andersonpa.polishhorseshoes.enums;
...
public final class ThrowType {
    ...
    public static final String[] typeString = {"Bottle", "Cup", "Pole", "Strike", "High",
            "Right", "Low", "Left", "Short", "Trap", "Redeemed Trap", "Not thrown", "Fired on"};
